...
import LecturesButton from "../images/lectures-button";
import ResumeLastVideoButton from "../images/resume-last-video-button";
import SetTasksButton from "../images/set-tasks-button";
