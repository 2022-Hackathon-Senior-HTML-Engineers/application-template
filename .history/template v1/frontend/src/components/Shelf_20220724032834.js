              ...
              <Grid container spacing={0}>
                ...
                <Grid item xs={6} md={8}>
                  <div className="nav-right">
                    ...
                    />
                    <img src={FinishButton} className="finish-button" onClick={() => [].concat(ShelfItemsCollection.slice(0,currentTaskState),ShelfItemsCollection.slice(currentTaskState, 14),[15])}/>
