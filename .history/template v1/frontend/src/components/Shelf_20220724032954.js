              ...
              <Grid container spacing={0}>
                ...
                <Grid item xs={6} md={8}>
                  <div className="nav-right">
                    ...
                    />
                    <img src={FinishButton} className="finish-button" onClick={() => setShelfItemsCollection[].concat(ShelfItemsCollection.slice(0,currentItemState),ShelfItemsCollection.slice(currentItemState+1, 14),[15])}/>
