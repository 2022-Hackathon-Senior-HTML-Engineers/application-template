            ...
            <div className="grid-container">
              {onDisplay.map((DisplayItem, i) => (
                <div
                  className="grid-item"
                  onClick={() => (
                    setCurrentItemState(DisplayItem[1]), setCurrentTaskState(DisplayItem[0])
                  )}
                >
                  <Tooltip title={<h2>{DrinksCollection[DisplayItem[1]].name}</h2>}>
                    <img
                      src={DrinksCollection[DrinksCollection[DisplayItem[1]].imageName}
                      className=""
                      alt={DrinksCollection[DrinksCollection[DisplayItem[1]].name}
                    />
                  </Tooltip>
                </div>
              ))}
